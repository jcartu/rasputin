...
const defaultProviders = [
  ...
  },
  {
    id: 'anthropic',
    name: 'Anthropic',
    description: 'Claude Opus 4.6, Sonnet 4.5 and other Anthropic models',
...
const defaultModels = [
  ...
  },
  {
    ...
    capabilities: ['chat', 'function-calling', 'vision', 'streaming', 'extended-thinking'],
    pricing: { inputPerMillion: 5, outputPerMillion: 25, currency: 'USD' },
    limits: { maxContextTokens: 200000, maxOutputTokens: 128000 },
    status: 'available',
    metrics: { averageLatency: 0, tokensPerSecond: 0, successRate: 1, totalRequests: 0, totalInputTokens: 0, totalOutputTokens: 0, totalCost: 0, errorCount: 0 },
    isDefault: true,
    tags: ['claude', 'coding', 'agents', 'vision'],
  },
  {
    ...
    limits: { maxContextTokens: 200000, maxOutputTokens: 64000 },
    status: 'available',
    metrics: { averageLatency: 0, tokensPerSecond: 0, successRate: 1, totalRequests: 0, totalInputTokens: 0, totalOutputTokens: 0, totalCost: 0, errorCount: 0 },
    tags: ['claude', 'fast', 'coding', 'vision'],
  },
  {
    id: 'claude-haiku-4-5',
...
const marketplaceModels = [
  ...
  {
    id: 'mp-claude-opus-4-6',
    name: 'Claude Opus 4.6',
    provider: 'anthropic',
    modelId: 'claude-opus-4-6',
    description: 'Most intelligent Claude model for building agents and coding',
    longDescription: 'Claude Opus 4.6 is Anthropic\'s most capable model, excelling at complex reasoning, agentic tasks, and coding. It supports extended thinking and has a 200K context window with 128K max output.',
    capabilities: ['chat', 'function-calling', 'vision', 'streaming', 'extended-thinking'],
    pricing: { inputPerMillion: 5, outputPerMillion: 25, currency: 'USD' },
    limits: { maxContextTokens: 200000, maxOutputTokens: 128000 },
    category: 'coding',
    tags: ['claude', 'coding', 'agents', 'vision', 'reasoning', 'anthropic'],
    rating: 4.9,
    reviewCount: 12000,
    ...
    benchmarks: [
      { name: 'MMLU', score: 92.1, maxScore: 100, category: 'knowledge' },
      { name: 'HumanEval', score: 95.0, maxScore: 100, category: 'coding' },
      { name: 'GSM8K', score: 97.8, maxScore: 100, category: 'math' },
    ],
    isFeatured: true,
    isNew: true,
  },
  ...
  {
    id: 'mp-claude-sonnet-4-5',
    name: 'Claude Sonnet 4.5',
    provider: 'anthropic',
    modelId: 'claude-sonnet-4-5',
    description: 'Best combination of speed and intelligence',
    longDescription: 'Claude Sonnet 4.5 offers the ideal balance of speed and capability. Excellent for coding, analysis, and creative tasks with fast response times.',
    capabilities: ['chat', 'function-calling', 'vision', 'streaming', 'extended-thinking'],
    pricing: { inputPerMillion: 3, outputPerMillion: 15, currency: 'USD' },
    limits: { maxContextTokens: 200000, maxOutputTokens: 64000 },
    category: 'general',
    tags: ['claude', 'fast', 'coding', 'vision', 'anthropic'],
    rating: 4.8,
    reviewCount: 9500,
    ...
    website: 'https://docs.anthropic.com/en/docs/about-claude/models',
    benchmarks: [
      { name: 'MMLU', score: 90.1, maxScore: 100, category: 'knowledge' },
      { name: 'HumanEval', score: 93.5, maxScore: 100, category: 'coding' },
...
let activeModelId = 'claude-opus-4-6';
