...
export default function Layout({ children }: LayoutProps) {
  ...
  const navItems = [
    { href: "/", label: "Executive Summary", icon: Terminal },
    { href: "/architecture", label: "System Architecture", icon: Network },
    { href: "/agents", label: "Swarm Agents", icon: Cpu },
    { href: "/memory", label: "Memory Systems", icon: Database },
    { href: "/daemon", label: "Desktop Daemon", icon: Zap },
    { href: "/security", label: "Security & Safety", icon: Shield },
    { href: "/implementation", label: "Roadmap", icon: Activity },
    { href: "/prototype", label: "Live UI Prototype", icon: Zap },
    { href: "/ingestion", label: "Ingestion Hub", icon: Download },
  ];
