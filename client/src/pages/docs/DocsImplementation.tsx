...
export default function DocsImplementation() {
  const phases = [
    {
      id: 1,
        ...
        <div className="relative space-y-8 before:absolute before:inset-0 before:ml-5 before:-translate-x-px md:before:mx-auto md:before:translate-x-0 before:h-full before:w-0.5 before:bg-gradient-to-b before:from-transparent before:via-border before:to-transparent">
          {phases.map((phase, i) => (
            ...
            >
              ...
              <Card
                className={`w-[calc(100%-4rem)] md:w-[calc(50%-2.5rem)] bg-card/50 border-border transition-all hover:border-primary/50 ${phase.status === "current" ? "border-primary shadow-[0_0_15px_rgba(0,243,255,0.1)]" : ""}`}
              >
