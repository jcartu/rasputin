...
export default function DocsIngestion() {
  ...
  useEffect(() => {
    fetch("/docs/chunks/manifest.json")
      .then(res => res.json())
              ...
              <CardContent>
                <div className="flex gap-2">
                  <Button
                    ...
                    variant="secondary"
                    onClick={() =>
                      window.open("/docs/downloads/jarvis_v3_full.md", "_blank")
                    }
                  >
                  ...
                  <Button
                    ...
                    onClick={() =>
                      copyToClipboard(
                        getFullUrl("/docs/downloads/jarvis_v3_full.md"),
                        "full-md"
                      )
                    }
                  >
              ...
              <CardContent>
                <div className="flex gap-2">
                  <Button
                    ...
                    onClick={() =>
                      window.open(
                        "/docs/downloads/jarvis_v3_full.txt",
                        "_blank"
                      )
                    }
                  >
                  ...
                  <Button
                    ...
                    onClick={() =>
                      copyToClipboard(
                        getFullUrl("/docs/downloads/jarvis_v3_full.txt"),
                        "full-txt"
                      )
                    }
                  >
