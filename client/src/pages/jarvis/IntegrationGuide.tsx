      ...
      content: (
        <div className="space-y-4">
          <p className="text-cyan-100/80 leading-relaxed">
            The <strong>RASPUTIN OS v0.3 UI Kit</strong> is a modular, drop-in frontend system designed to upgrade any React application with a cinematic, sci-fi interface. It includes a 3D holographic visualization engine, a multi-spectrum theme system, and a generative sound engine.
          </p>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-4">
            <div className="bg-black/40 border border-cyan-900/30 p-4 rounded-lg">
              ...
              <p className="text-xs text-cyan-100/60">Three.js holographic engine + Framer Motion animations.</p>
            </div>
            <div className="bg-black/40 border border-cyan-900/30 p-4 rounded-lg">
              ...
              <p className="text-xs text-cyan-100/60">10+ sci-fi color palettes with CSS variable architecture.</p>
            </div>
            <div className="bg-black/40 border border-cyan-900/30 p-4 rounded-lg">
              ...
              <p className="text-xs text-cyan-100/60">Generative Web Audio synthesizer for UI feedback.</p>
            </div>
          </div>
        </div>
      )
    },
    {
      ...
      content: (
        <div className="space-y-6">
          <div>
            <h3 className="text-sm font-bold text-cyan-300 mb-2">1. Install Dependencies</h3>
            <div className="bg-black/80 border border-cyan-900/50 rounded p-4 font-mono text-xs text-green-400 overflow-x-auto">
              pnpm add three @react-three/fiber @react-three/drei framer-motion lucide-react jspdf
            </div>
          </div>
          <div>
            <h3 className="text-sm font-bold text-cyan-300 mb-2">2. Copy Asset Structure</h3>
            <p className="text-xs text-cyan-100/60 mb-2">Ensure your project structure matches the following layout for seamless integration:</p>
...
└── index.css                     # CSS Variables & Tailwind`}
    ...
    },
    {
      ...
      content: (
        <div className="space-y-6">
          <div>
            <h3 className="text-sm font-bold text-cyan-300 mb-2">1. Wrap Your App</h3>
            <p className="text-xs text-cyan-100/60 mb-2">Wrap your root component with the <code>ThemeProvider</code> to enable the multi-spectrum engine.</p>
  ...
  return (
    <ThemeProvider>
      ...
      <YourMainContent />
          ...
          <div>
            <h3 className="text-sm font-bold text-cyan-300 mb-2">2. Connect Real Data</h3>
            <p className="text-xs text-cyan-100/60 mb-2">The <code>Research</code> component accepts a <code>models</code> prop. Map your WebSocket data to this interface:</p>
      ...
      <div className="max-w-4xl mx-auto">
        <div className="mb-12 border-b border-cyan-900/30 pb-8">
          <h1 className="text-4xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-blue-600 mb-4">
            RASPUTIN OS v0.3 <span className="text-white/20 font-mono text-lg">INTEGRATION MANUAL</span>
          </h1>
          <p className="text-xl text-cyan-100/60">
            Technical documentation for deploying the House Cartu interface system.
          </p>
        </div>
          ...
          {sections.map((section) => (
            ...
            >
              <div className="flex items-center gap-4 mb-6">
                ...
                <h2 className="text-2xl font-bold text-cyan-100">{section.title}</h2>
              </div>
        ...
        <div className="mt-16 p-8 bg-gradient-to-r from-cyan-900/20 to-transparent border border-cyan-500/30 rounded-xl flex items-center justify-between">
          <div>
            <h3 className="text-xl font-bold text-cyan-100 mb-2">Ready to Deploy?</h3>
            <p className="text-cyan-100/60 text-sm">Download the complete source package including all assets and components.</p>
          </div>
