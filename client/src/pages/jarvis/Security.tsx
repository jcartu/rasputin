    ...
    <Layout>
      <div className="space-y-10">
        ...
        >
          ...
          <AlertDescription>
            Autonomous agents must never have unchecked root access. All
            privileged actions require explicit capability tokens.
          </AlertDescription>
        </Alert>
        ...
        <div className="grid gap-6 md:grid-cols-2">
          <Card className="bg-card/50 border-border">
            ...
            <CardContent className="space-y-4 text-sm text-muted-foreground">
              <p>
                Agents do not have inherent permissions. To perform sensitive
                actions (e.g., file write, network request), an agent must
                request a short-lived <strong>Capability Token</strong> from the
                Orchestrator.
              </p>
              <ul className="list-disc list-inside space-y-1 ml-2">
                <li>Tokens expire after 5 minutes</li>
                <li>
                  Tokens are scoped to specific resources (e.g.,
                  `/home/user/project/*`)
                </li>
          ...
          <Card className="bg-card/50 border-border">
            ...
            <CardContent className="space-y-4 text-sm text-muted-foreground">
              <p>
                For high-risk actions, the system enforces a mandatory human
                approval step.
              </p>
              <ul className="list-disc list-inside space-y-1 ml-2">
                <li>
                  <strong>Level 1 (Safe)</strong>: Read-only ops (Auto-approved)
                </li>
                <li>
                  <strong>Level 2 (Standard)</strong>: File writes in sandbox
                  (Notify only)
                </li>
                <li>
                  <strong>Level 3 (Critical)</strong>: System config, payments,
          ...
          <div className="rounded-lg border border-border bg-black/50 p-6">
            <div className="space-y-4">
              <div className="flex items-center gap-4 p-4 rounded bg-card/30 border border-border">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    All code execution happens in ephemeral, network-restricted
                    containers.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-4 p-4 rounded bg-card/30 border border-border">
                ...
                <div>
                  <h3 className="font-bold font-mono text-blue-400">
                    gRPC Isolation
                  </h3>
                  <p className="text-sm text-muted-foreground">
                    The Desktop Daemon listens only on localhost with mTLS
                    authentication.
                  </p>
                </div>
              </div>
